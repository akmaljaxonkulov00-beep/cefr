...
export default function StudentIeltsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] p-6 lg:p-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">IELTS Mock Testlar</h1>
        <p className="text-gray-400">IELTS imtihoniga tayyorgarlik ko'rish uchun to'liq mock testlar ({filteredMocks.length} ta)</p>
      </div>
