...
export default function StudentIeltsResultPage() {
    ...
    <div className="min-h-screen bg-[#0f172a] p-6 lg:p-8">
      ...
      <div className="glass-dark rounded-2xl p-8 mb-6 text-center">
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-white">Umumiy Band Score</h2>
        </div>
        <div className="text-7xl font-bold text-white mb-2">{attempt.totalBand}</div>
        <div className="text-gray-400">
          {attempt.mock.type} - {attempt.mock.level}
        </div>
      </div>
        ...
        <div className="space-y-4">
          {attempt.listeningScore < 60 && (
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
              ...
              <div className="text-gray-400 text-sm">
                Ko'proq audio materiallarni tinglash va IELTS listening amaliyotlarini qilish tavsiya etiladi.
              </div>
            </div>
          )}
          ...
          {attempt.readingScore < 60 && (
            <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-4">
              ...
              <div className="text-gray-400 text-sm">
                Har kuni o'qish amaliyotini oshiring va vaqtni boshqarishni yaxshilang.
              </div>
            </div>
          )}
