  ...
  const handleStart = async () => {
    ...
    try {
      if (attempt?.status === 'in_progress') {
        router.push(`/student/cefr/${mockId}/exam`);
      } else {
        await api.post(`/api/cefr/student/mocks/${mockId}/start`);
        router.push(`/student/cefr/${mockId}/exam`);
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-[#0f172a] p-6 lg:p-8">
      ...
      {attempt && (
        <div className="glass-dark rounded-2xl p-6 mb-6">
          <div className="flex items-center justify-between">
            ...
            {attempt.status === 'completed' && attempt.level && (
              <button
        ...
        <div className="glass-dark rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <div className="text-gray-400 text-sm">{mock.listening?.duration || 40} daqiqa</div>
            </div>
          </div>
          <div className="text-gray-400 text-sm">
        ...
        <div className="glass-dark rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <div className="text-gray-400 text-sm">{mock.writing?.duration || 80} daqiqa</div>
            </div>
          </div>
          <div className="text-gray-400 text-sm">
            Task 1.1, 1.2, 2
        ...
        <div className="glass-dark rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <div className="text-gray-400 text-sm">10-15 daqiqa</div>
            </div>
          </div>
          <div className="text-gray-400 text-sm">
            Task 1, 2, 3
      ...
      <div className="glass-dark rounded-2xl p-6 mb-6">
        ...
        <ul className="space-y-2 text-gray-400">
          ...
          <li className="flex items-start gap-2">
            <span className="text-primary-500">•</span>
            Imtihon tugagandan so'ng natijalar avtomatik hisoblanadi va CEFR darajasi aniqlanadi
          </li>
        </ul>
      </div>
