...
const getNavItems = (role: string | undefined) => {
  ...
  return [
    ...
    { href: '/student/cefr-parts', icon: BookOpen, label: 'CEFR' },
    { href: '/student/ai-speaking', icon: Mic, label: 'AI Speaking' },
    { href: '/student/ai-writing', icon: PenLine, label: 'AI Writing' },
